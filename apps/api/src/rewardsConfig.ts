...
function loadRewardsRuntimeConfig(): RewardsRuntimeConfig {
  return {
    ...
    inventoryExitSecondsToClose: parsePositiveInteger(process.env.REWARDS_INVENTORY_EXIT_SECONDS_TO_CLOSE, 3_600),
    maxExtremeInventoryLossPerShare: numberEnv('REWARDS_MAX_EXTREME_INVENTORY_LOSS_PER_SHARE', 0.2),
